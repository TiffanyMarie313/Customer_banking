...
def main():
    ...
    savings_maturity = int(input("Enter the length of months")) 
    ...
    cd_interest = float(input("Enter your interest rate (as a percentage): "))
    cd_maturity = int(input("Enter the length of months: "))
